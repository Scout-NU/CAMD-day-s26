export function render() {
  return `
    <nav id="navbar" class="fixed top-0 w-full z-50 flex justify-end gap-14 px-16 py-6 transition-transform duration-300 ease-in-out">
      <a href="#recap"        data-section="recap"        class="nav-link text-white text-4xl font-akshar transition-colors">RECAP</a>
      <a href="#gallery"     data-section="gallery"     class="nav-link text-white text-4xl font-akshar transition-colors">GALLERY</a>
      <a href="#publications" data-section="publications" class="nav-link text-white text-4xl font-akshar transition-colors">PUBLICATIONS</a>
